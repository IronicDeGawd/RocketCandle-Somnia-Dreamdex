...
const OUT = path.join(__dirname, "..", ".env.newattestor");
...
fs.writeFileSync(OUT, `NEW_ATTESTOR_PRIVATE_KEY=${wallet.privateKey}\n`, {
  mode: 0o600,
});

console.log(`New attestor address: ${wallet.address}`);
console.log(`Key written to     ${OUT} (mode 600, gitignored)`);
console.log("");
console.log("Next:");
console.log(`  NEW_ATTESTOR_ADDRESS=${wallet.address} npx hardhat run scripts/rotate-attestor.js --network somnia`);
